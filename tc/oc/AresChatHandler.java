        ...
        if (message.contains(" joined the game")) {
            ...
            if (message.contains("left the game")) {
                ...
                if (message.contains("Now playing")) {
                    ...
                    if (message.startsWith(username) && (message.contains(" by ") || message.contains(" took "))) {
                        AresData.addKilled(1);
                        AresData.resetKillstreak();
                    } //if you kill a person
                    else {
                        if (message.contains("by " + username) || message.contains("took " + username)) {
                            AresData.addKills(1);
                            ...
                            if (message.contains("You joined the")) {
                                ...
                                if (!message.startsWith("<") && message.toLowerCase().contains("cycling to") && message.contains("1 second")) {
                                    ...
                                    if (message.startsWith("[Tip]") && mod_Ares.CONFIG.filterTips) {
                                        ...
                                        if (message.contains("Welcome to")) {
                                            ...
                                            if (message.contains("Teleporting you to ")) {
                                                ...
                                                if (message.contains("You are currently on ")) {
