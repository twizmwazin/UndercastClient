	...
	// TODO: Check for captured wools
		...
		public void clientChat(String var1)
		{
			...
			if (this.onPA)
			{
				...
				else if (!var2.startsWith("<") && var2.contains("You are currently on"))
				{
					this.serverName = var2.replace("You are currently on ", "");
				}

				else if (!var2.startsWith("<") && var2.contains("Cycling to"))
				{
					...
					this.map = this.mapname[0];
	            		...
	            		else if (!var2.startsWith("<") && var2.contains(" placed ") && var2.contains("for the"))
	           		{
           			...
           			else if (!var2.startsWith("<") && var2.contains("left the game"))
            			{
            			...
            			else if (var2.startsWith("<") || !var2.contains("was shot by " + mc.thePlayer.username.toString()) && !var2.contains("was blown up by " + mc.thePlayer.username.toString()) && !var2.contains("was slain by " + mc.thePlayer.username.toString()))
            			{
            		...
            		//TODO: While formatting i saw this and have no idea where it actually belongs, your coding / my old code is a mess
            		/*else
            		{
                		++this.kills;
                		++this.killStreak;
           			...
           			else if (!var2.startsWith("<") && var2.contains("Game Over!"))
            			{
