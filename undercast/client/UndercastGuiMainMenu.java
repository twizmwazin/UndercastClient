...
public class UndercastGuiMainMenu extends GuiMainMenu {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100,
                this.height / 4 + 72, 99, 20, I18n
                        .func_135053_a("menu.multiplayer")));
        this.buttonList.add(new GuiButtonTooltip(7, this.width / 2 + 1,
                this.height / 4 + 72, 99, 20, "Overcast Network",
                "Serverlist with Overcast Network Servers"));
    }
