...
public class UndercastGuiGameOver extends GuiScreen {
        ...
        if (this.mc.theWorld.getWorldInfo().isHardcoreModeEnabled()) {
            if (this.mc.isIntegratedServerRunning()) {
                this.buttonList.add(new GuiButton(1, this.width / 2 - 100,
                        this.height / 4 + 96, StatCollector
            ...
            this.buttonList.add(new GuiButton(1, this.width / 2 - 100,
                    this.height / 4 + 72, StatCollector
                            .translateToLocal("deathScreen.respawn")));
            this.buttonList.add(new GuiButton(2, this.width / 2 - 100,
                    this.height / 4 + 96, StatCollector
                            .translateToLocal("deathScreen.titleScreen")));
    ...
    public void drawScreen(int par1, int par2, float par3) {
        this.drawGradientRect(0, 0, this.width, this.height, 1615855616,
                -1602211792);
        GL11.glPushMatrix();
        ...
        this.drawCenteredString(this.fontRenderer, s, this.width / 2 / 2, 30,
                16777215);
        GL11.glPopMatrix();
        ...
        this.drawCenteredString(
                ...
                StatCollector.translateToLocal("deathScreen.score") + ": "
                        ...
                        + this.mc.thePlayer.getScore(), this.width / 2, 100,
                16777215);
        if (UndercastData.isOC) {
            this.drawCenteredString(this.fontRenderer,
                    "Killstreak" + ": " + EnumChatFormatting.YELLOW
                            + (int) UndercastData.getPreviousKillstreak(),
    ...
    public void updateScreen() {
        ...
        if (this.cooldownTimer == 20) {
            for (Iterator iterator = this.buttonList.iterator(); iterator
                    .hasNext(); guibutton.enabled = true) {
                guibutton = (GuiButton) iterator.next();
            }
        }
    }
