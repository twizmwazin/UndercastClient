...
public class BeastnodeButton extends GuiButton {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
        if (this.visible) {
            ...
            GL11.glPopMatrix();
            if (hovered)
                drawHoveringText(Collections.singletonList(EnumChatFormatting.AQUA + "Undercast Client " + EnumChatFormatting.WHITE + "is sponsored by " + EnumChatFormatting.BLUE + EnumChatFormatting.BOLD + "Beastnode"), par2, par3, Minecraft.getMinecraft().fontRendererObj);
        }
    }
